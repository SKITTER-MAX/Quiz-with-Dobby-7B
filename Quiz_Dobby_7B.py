...
# Dynamic quiz questions generated by DOBBY 7B
QUIZ_QUESTIONS = []
...
# Remove the duplicate route that might exist
# @app.route('/simple_quiz')
# def simple_quiz():
#     return render_template('simple_quiz.html')
...
Don't just repeat their score - give meaningful insights about their blockchain knowledge journey."""
        ...
        if response.status_code == 200:
            ...
            return jsonify({"response": f"Excellent work completing the quiz! You scored {score}/{total}. Every question you answered correctly shows your growing blockchain expertise. Keep exploring this fascinating technology! 🚀"})
            
    except Exception as e:
        return jsonify({"response": f"Congratulations on completing the blockchain quiz! You scored {score}/{total}. Each question you tackled brings you closer to mastering blockchain technology. Keep learning and stay curious! 🤖"})

if __name__ == '__main__':
    print("🎓 Starting Dobby the Educator...")
    print("📡 Each quiz will have 10 fresh questions generated by Dobby the Educator!")
